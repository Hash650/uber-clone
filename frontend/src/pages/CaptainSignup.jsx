  ...
  return (
    ...
    <img className="w-16 mb-2" src="https://www.svgrepo.com/show/505031/uber-driver.svg" alt="" />
      <form action="" onSubmit={submitHandler}>
        ...
        <h3 className='text-lg font-medium  mb-6'>What's our Captain's name?</h3>
      ...
      <p className='text-center font-light mb-3'>Already have an account? <Link to={'/captain-login'} className='text-blue-600 font-normal underline'>Login here</Link></p>
    </div>
    <div>
